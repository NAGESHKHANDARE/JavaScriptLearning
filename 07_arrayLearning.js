...
let slicetResult = arrayOfNum.slice(3);  // write from 3 index (if count start zero)
...
console.log("Array after deleting element", arrayOfNum);
console.log("Total deleted element using splice method : ",spliceResult);
...
console.log("Array after deleting element", arrayOfNum);
console.log("Total deleted element using splice method : ",spliceRes);
...
console.log("cheak value 9 in array : ",isAvailable);  

let isAvailab100  = arrayOfNum.includes(100);
console.log("cheak value 100 in array : ",isAvailab100);  
...
console.log(arrayOfNum);
console.log(arrayOfNum.length);//[66, ...]
